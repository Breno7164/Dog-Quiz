//Tela inicial com duas opções de interação (uso do mouse): "jogar" e "sobre". Caso o jogo seja iniciado, mostra a imagem do cachorro com as opções correspondentes (vetores), a pontuação será calculada a partir do número de acertos do jogador, que ao terminar, será levado para uma tela de final com a pontuação (mostrar opção para retornar  tela 1). Caso seja selecionado o menu "sobre", as informações sobre o que é o jogo serão apresentadas (com botão para retornar a tela 1).//
...
function preload(){
  ...
  img2 = loadImage('fundo_inicial_2.png');
  logo = loadImage('logo.png');
  fim_logo = loadImage('fim.png');
  dog_logo = loadImage('dog.png');
